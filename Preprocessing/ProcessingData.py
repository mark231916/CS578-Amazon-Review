...
import pandas as pd
import numpy as np
negative_review=pd.read_csv('/Users/yangmian/Downloads/processed_acl/electronics/negative_review.txt',header=None)
positive_review=pd.read_csv('/Users/yangmian/Downloads/processed_acl/electronics/positive_review.txt',header=None)
